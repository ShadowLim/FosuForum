...
@WebServlet("/StudyReleaseCntByDatePoServlet")
public class StudyReleaseCntByDatePoServlet extends HttpServlet {
    ...
    protected void service(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Object> barData = poService.studyReleaseCntByDate(u_id);

        // TODO 返回barData
        resp.setContentType("text/html;charset=utf-8");
        resp.getWriter().println(barData);

        req.setAttribute("studyReleasePoList", barData);
        req.getRequestDispatcher("studyReleaseCntPo.jsp").forward(req, resp);
    }
}
