...
<div class="container">
    <div style="width: 600px;height:100px;">
        <nav class="navbar navbar-default" role="navigation" style="float: right; position:absolute; width:1125px; margin:0px 0 0 200px ">
            ...
            <h3><b><center>按时间（年月）分组统计学习专区帖子发表数量</center></b></h3>

            <%
                List<Object> poList = (List<Object>) request.getAttribute("studyReleasePoList");
            %>
        </nav>
    </div>
...
<%--    <div class="row">--%>
<%--        <jsp:include page="replyCntPo.jsp"></jsp:include>--%>
<%--    </div>--%>
