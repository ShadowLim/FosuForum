...
<body class="bk">
<div class="login">
    <form class="form1" id="form1" method="post" action="LoginServlet">
        ...
        <button class="btn btn-lg btn-primary btn-block" onclick="location.href='TouristHomeServlet'" type="submit">返回</button>
    </form>
</div>
</body>
</html>