      ...
      <div class="navbar-header">
        <a class="navbar-brand" href="TouristHomeServlet">「Fosu Forum」</a>
          ...
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="${pageContext.request.contextPath}/ReleaseCntByMontnPoServlet?uid=${user.user_id}"><span class="glyphicon glyphicon-user"></span> 数据报表</a></li>
  ...
  <div  class="container">
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <form name="form1" method="post" action="/TouristFindReplyServlet">
