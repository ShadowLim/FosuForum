...
<div class="container">
    <div style="width: 600px;height:100px;">
        <nav class="navbar navbar-default" role="navigation" style="float: right; position:absolute; width:1125px; margin:0px 0 0 200px ">
            ...
            <h3><b><center>统计普通用户学习帖子发表数量</center></b></h3>

            <%
                List<Object> poList = (List<Object>) request.getAttribute("studyCntByUserList");
            %>
        </nav>
    </div>
    ...
    <script type="text/javascript">
        ...
        // alert("学习帖子size:" + size);         // 4

        // var list = "[20201001, 9, 20201002, 1]";
        var list = "<%=poList%>";
