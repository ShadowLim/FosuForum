    ...
    <div class="container">
        <div class="leftcolumn">
            ...
            <%
                ...
                List<StudyEntity> list = (List<StudyEntity>)request.getAttribute("studyList");
                if (list == null) {
                    out.println("恭喜您是第一个新用户，赶紧去发帖吧！");
                } else {
                    for(StudyEntity study : list) {
                        // TODO /FosudForum/images/cover/002.png
...
//                        System.out.println("startIdx:" + startIdx);
            ...
            <a href="StudyReplyListServlet?sid=<%=study.getSid()%>"> <h2><%=study.getTitle()%></h2> </a>

            <p>
                Created By
                <a href="FindUserByIdServlet?uid=<%=study.getAuthor().getUser_id()%>">
        ...
        <div class="rightcolumn">
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <a href="${pageContext.request.contextPath}/study.jsp">
